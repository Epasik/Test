...
def user_settings(argument):
    ...
    label7.config(text=text5message.get(), font=(text1message.get() + ' ' + text2message.get() + ' ' + text4message.get()), fg=(text3message.get()))
...
button1= tk.Button(window, text = "Сохранить", font = "Arial 8", command = save,
...
button2 = tk.Button(window, text = "Очистить", font = "Arial 8",command = dl,
padx="10", # отступ от границ до содержимого по горизонтали
pady="10", # отступ от границ до содержимого по вертикал
height = "1",
width = "18")
